...
class ImageGenerator(commands.Cog):
    ...
    async def _generate_image(self, **kwargs: str):
    ...
    async def _download_image(self, ctx, url) -> io.BytesIO:
        """
    ...
    async def _send_image(self, ctx, image_data: io.BytesIO, filename: str, caption: str) -> None:
    ...
    async def _upload_generated_image(self, image_data: io.BytesIO, obj_filename: str, bucket_name: str) -> None:
    ...
    async def _store_generated_image(self, obj_filename: str, minio_link: str, username: str, prompt: str, caption: str):
    ...
    async def img(self, ctx, *, prompt):
        ...
        try:
            image = await self._download_image(ctx, image_result.data[0].url)
