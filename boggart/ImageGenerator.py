...
class ImageGenerator(commands.Cog):
    ...
    async def __upload_generated_image(self, image_data: io.BytesIO, b2_filename: str, bucket_name: str) -> None:
    ...
    # todo: switch to local object store
    async def __store_generated_image(self, b2_filename: str, b2_link: str, username: str, prompt: str, caption: str):
